...
const I18N: any = {
  '中文': {
    ...
    ocrUsageNoteLabel: '按系统内部扣减统计，不是云厂商后台实时余额。',
  ...
  'English': {
    ...
    imageViewportSmartLabel: 'Smart',
    imageViewportAmountLabel: 'Amounts',
    imageViewportFullLabel: 'Full',
    ...
    ocrQuotaLabel: 'Monthly processing usage',
    ocrUsageNoteLabel: 'System-side monthly counters, not live vendor account balance.',
    ocrUsageCallCountLabel: (count: number) => `${count} call${count === 1 ? '' : 's'}`,
  ...
  'Melayu': {
    ...
    imageViewportSmartLabel: 'Pintar',
    imageViewportAmountLabel: 'Amaun',
    imageViewportFullLabel: 'Penuh',
    ...
    ocrQuotaLabel: 'Penggunaan pemprosesan bulanan',
    ocrUsageNoteLabel: 'Kiraan bulanan dalaman sistem, bukan baki langsung vendor.',
    ocrUsageCallCountLabel: (count: number) => `${count} panggilan`,
